...
class Question(models.Model):
    ...
    test = models.ForeignKey('Test1', on_delete=models.CASCADE, related_name='questions')
...
class Test1(GeneralTest):
    ...
    lesson = models.ForeignKey('Lesson', on_delete=models.CASCADE, related_name='test1')
